 ...
 */
public final class SubOrderQueryResponse extends AbstractApiResponse implements Serializable {
    private static final long serialVersionUID = -7755200695702266470L;
    ...
    public String toString() {
        return new StringJoiner(", ", SubOrderQueryResponse.class.getSimpleName() + "[", "]")
